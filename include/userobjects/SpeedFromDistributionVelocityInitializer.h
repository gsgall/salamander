...
class Distribution;
class SpeedFromDistributionVelocityInitializer : public VelocityInitializerBase
{
public:
  SpeedFromDistributionVelocityInitializer(const InputParameters & parameters);
...
protected:
  ...
  Distribution const * _speed_distribution;
  /// Velocity distribution names
  const DistributionName & _distribution_name;
};
