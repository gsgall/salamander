 ...
 *
 */
class CustomHistogramVectorPostprocessor : public GeneralVectorPostprocessor
{
public:
  static InputParameters validParams();

  CustomHistogramVectorPostprocessor(const InputParameters & parameters);
...
protected:
   ...
   *
   * @param stat_vector The vector to compute a CustomHistogram of
  ...
  /// The VPP vectors that will hold the CustomHistogram for each column
